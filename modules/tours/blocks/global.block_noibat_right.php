...
if (! nv_function_exists('nv_block_tours_noibat_right')) {
    ...
    function nv_block_config_tours_noibat_right($module, $data_block, $lang_block)
    {
    ...
    function nv_block_config_tours_noibat_right_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_block_tours_noibat_right($block_config)
    {
        ...
        if (! empty($list)) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/tours/global.block_groups_right.tpl')) {
            ...
            $xtpl = new XTemplate('global.block_groups_right.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/tours');
...
if (defined('NV_SYSTEM')) {
    global $site_mods, $module_name,$db_config, $array_cat, $module_array_cat, $nv_Cache, $db, $array_vehicle, $module_array_vehicle, $array_hotels, $module_array_hotels;
    $module = $block_config['module'];
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_tours_noibat_right($block_config);
    }
}

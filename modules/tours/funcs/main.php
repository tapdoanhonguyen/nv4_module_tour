...
// hien thi tat ca, 0: luoi, 1: danh sach
if (in_array($array_config['home_type'], array(
    0,
    2
))) {
    $viewtype = 'viewgrid';
    if ($array_config['home_type'] == 2) {
        $viewtype = 'viewlist';
    }
    ...
    $contents = nv_theme_tours_main($array_data, $viewtype, $page);

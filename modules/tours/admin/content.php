...
if (! empty($row['hotels_info'])) {
    foreach ($row['hotels_info'] as $hotels_info) {
        ...
        if($hotels_info['time_begin'] and $hotels_info['time_end']){

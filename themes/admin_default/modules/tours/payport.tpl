...
<form class="form-inline" action="" method="post">
	<table class="table table-striped table-bordered table-hover">
		<tbody>
			...
			<tr>
				<td>{LANG.image}</td>
				<td><input class="form-control" style="width:400px" type="text" name="images_button" id="homeimg" value="{DATA.images_button}"/><input type="button" value="{LANG.image_c}" name="selectimg" class="btn btn-info" style="margin-left: 5px" /></td>
			</tr>
			<tr>
...
<table id="edit" class="table table-striped table-bordered table-hover">
	...
	<thead>
		<tr>
			...
			<td><strong>{LANG.payment_name}</strong></td>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center"><i class="fa fa-edit">&nbsp;</i><a href="{DATA_PM.link_edit}">{LANG.edit}</a></td>
		</tr>
		<!-- END: paymentloop -->
	</tbody>
</table>
...
<table id="edit" class="table table-striped table-bordered table-hover">
	...
	<thead>
		<tr>
			...
			<td><strong>{LANG.payment_name}</strong></td>
			<td><strong>{LANG.domain}</strong></td>
			<td width="100" class="text-center"><strong>{LANG.function}</strong></td>
		</tr>
	</thead>
	<tbody>
		<!-- BEGIN: opaymentloop -->
		<tr>
			...
			<td class="text-center"><i class="fa fa-edit">&nbsp;</i><a href="{ODATA_PM.link_edit}">{LANG.payment_integrat}</a></td>
		</tr>
		<!-- END: opaymentloop -->
	</tbody>
</table>
